    ...
    return (
        <div className="flex" >
            <div className=" mx-auto">
                <nav className="flex flex-col bg-white  w-screen">
                    <div className="hidden md:flex px-12 pt-4 mx-auto mr-0 font-semibold font-heading space-x-6">
                        {topMenu.map((item) => <li key={item.name.toLowerCase()}>
                            <a className="no-underline text-gray-500 hover:text-black" href={item.link}>{item.name}</a>
                        </li>)}
                    </div>
                    <div className="flex justify-between">
                        <div className="px-5 xl:px-12 md:pt-0 py-6 flex w-full items-center">
                            <a className="text-3xl no-underline text-black font-bold font-heading" href="#">
                                ECOMMERCE
                            </a>
                            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                                {menuItems.map((item) => <li key={item.name.toLowerCase()}>
                                    <a className="no-underline text-black hover:text-gray-200" href={item.link}>{item.name}</a>
                                </li>)}
                            </ul>
                        ...
                        <a className="navbar-burger self-center mr-4 xl:hidden" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="black">
