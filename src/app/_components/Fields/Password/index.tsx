    ...
    return (
        <>
            ...
            <div className='flex flex-row'>
                <input className="p-2 rounded" type={showPassword ? "text" : "password"} id="password" name="password" placeholder="Enter a password" onChange={(e) => setFormData({ ...formData, password: e.target.value })} />
